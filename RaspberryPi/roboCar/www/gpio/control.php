...
//////////////////////////////
$MySQLUsername = "roboCar";
$MySQLPassword = "#razib3417#";
...
If (isset($_GET['action'])){
	...
	print '
		<html>
		<head>
		<title>Control Your Home</title>
		</head>
		<font face="verdana">
		<p>Control Your Home   <a href="control.php?action=setPassword">Change Password</a></p>
		';
