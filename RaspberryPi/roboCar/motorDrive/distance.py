...
def checking():
    ...
    sonic()
    print "Checking front : %.1f" % myList[0]
    time.sleep(0.5)


    sonicPulse.ChangeDutyCycle(12.5)
    sonic()
    print "checking right : %.1f" % myList[1]
    time.sleep(0.5)
    #sonic()
 
    sonicPulse.ChangeDutyCycle(3.5)
    sonic()
    print "checking left : %.1f" % myList[2]
    time.sleep(0.5)
    #sonic()
